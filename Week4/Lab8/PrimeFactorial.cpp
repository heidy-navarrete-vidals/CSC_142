/*
    ...
    FileName: PrimeFactorial.cpp
    Description: Use methods to calculate and display prime/factorial numbers
    Date: 2/11/2025
...
int main() {
    ...
    {    
        ...
        bool primeStatus = isPrime(randomNum);
        double fact = factorial(randomNum);


        // Display
        std::cout<<"\nYour random number is: "<<randomNum<<std::endl;
        if (primeStatus)
        {
            std::cout<<"This is a prime number!"<<std::endl;
            std::cout<<"The factorial of that number is: "<<fact<<std::endl;
        }
        else
        {
