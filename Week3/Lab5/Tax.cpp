/*
    ...
    Description: Create a tax calculator for the user's specific purchase.
    File Name: Tax.cpp
    Date: 2/3/2025
...
int main() {
    ...
    bool keepGoing = true;
    double priceValue = 0, taxPurchase = 0, totalPurchase = 0;
    std::string desc, priceString, again;

    while (keepGoing) {
        std::cout<<"Please enter a description for your purchase: "<<std::endl;
        ...
        do 
        {
            ...
            priceValue = std::stod(priceString);
        }
        while (priceValue < 0);


        // Calculations
        taxPurchase = priceValue * TAX;
        totalPurchase = priceValue + TAX;
        ...
        std::cout<<"Purchase Description: "<<desc<<std::endl;
        std::cout<<"Your sales tax on your purchase: $"<<taxPurchase<<std::endl;
        std::cout<<"Your total purchase amount: $"<<totalPurchase<<std::endl;
