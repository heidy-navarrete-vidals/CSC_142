/*
    ...
    Description: Use in/out file types to read and write into another file.
...
int main() {
    ...
    std::cout<<"Enter the .txt file you would like to write to:"<<std::endl;
    std::getline(std::cin, writingFile);
