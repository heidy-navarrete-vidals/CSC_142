...
int main(){   
    ...
    mpg = miles / gallons;
    // miles to kilometers = miles * KM_PER_MILE
    kilometers = miles * KM_PER_MILE;
    // gallons to liters = gallons * LITERS_PER_GALLON
    liters = gallons * LITERS_PER_GALLON;
    // l/100km calculation
    lkm = (100 / (mpg * KM_PER_MILE)) * LITERS_PER_GALLON;

    // Print the user inputs and final results + extra credit code
    ...
    std::cout<<"Your fuel efficiency is " << lkm << " liters per 100km."<<std::endl;
